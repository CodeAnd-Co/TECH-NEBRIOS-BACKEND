...
exports.getEliminadas = async (req, res) => {
    try {
        const resultado = await Reporte.obtenerEliminadas();
...
exports.postDescargarExcel = async (req, res) => {
    try {
        ...
        const eliminadas = await Reporte.obtenerEliminadas();
        ...
        const buffer = await generarExcelDesdeDatos(datos, eliminadas);
